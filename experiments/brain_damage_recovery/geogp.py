...
class GaussianRandomField(object):
    ...
    def __init__(self, domain, mesh, kernel, upto, geoaccuracy = 1):
        ...
        navigator = Navigator(domain, fespaces.mesh(domain, stepsize = geoaccuracy))
        ...
        self.singvalues, self.eigenfunctions = KarhunenLoeve(mesh, self.cov, self.n, distances)
...
def KarhunenLoeve(mesh, covariance, nphis, distances):
